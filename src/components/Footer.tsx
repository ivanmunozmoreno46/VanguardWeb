...
export default function Footer() {
  return (
    <footer className="w-full relative tech-panel mt-16 text-[var(--color-chrome)]">
      ...
      <div className="p-4 sm:p-8 grid grid-cols-2 md:grid-cols-4 gap-8">
        ...
        <div className="col-span-2 text-right flex flex-col justify-between">
          <div className="font-display text-4xl sm:text-6xl font-bold tracking-[-0.05em] uppercase mb-4 text-[var(--color-carbon)] leading-none flex items-start gap-4">
          ...
          <div className="font-mono text-[8px] tracking-[0.2em] flex justify-end space-x-8 uppercase text-[var(--color-intl-orange)] font-bold">
