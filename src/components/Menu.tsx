      ...
      <nav className="fixed top-0 left-0 w-full p-6 flex justify-between items-center z-[50] pointer-events-none">
        <div className="flex gap-4 items-center pointer-events-auto">
           ...
           <div className="flex flex-col items-start">
              <div className="font-display text-sm font-bold tracking-tighter uppercase leading-none mb-1">
                VANGUARD WEB
              </div>
              <div className="flex flex-col gap-1 items-start">
                 <div className="bg-[var(--color-carbon)] text-[var(--color-paper)] p-1.5 font-display text-[8px] font-bold tracking-widest opacity-90 backdrop-blur-sm">
                   SYS_STATUS // <span className="text-[var(--color-intl-orange)]">ACTIVE</span>
                 </div>
                 <div className="font-mono text-[8px] text-[var(--color-carbon)] opacity-40 ml-1 leading-none">
                   {coords}
                 </div>
              </div>
           </div>
